        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <div class="row mt-3 mb-5">
            <div class="col-md-12">
              ...
              <h6 class="card-header">Input Data Rumah</h6>
              <div class="card-body">
                <form method="post">
                  <div class="mb-3">
                    <label for="id" class="form-label">ID</label>
                    <input type="number" name="id_rumah" class="form-control" id="id" readonly="readonly" placeholder="ID">
                  </div>
                  <div class="mb-3">
                    <label for="no_rumah" class="form-label">Nomor Rumah</label>
                    <input type="text" name="no_rumah" class="form-control" id="no_rumah" placeholder="Nomor Rumah">
                  </div>
                  <div class="mb-3">
                ...
                <?php
                if (isset($_POST['save'])) {
                  $query = mysqli_query($koneksi, "INSERT INTO data_rumah(id_rumah,no_rumah,type_rumah,status)VALUES('$_POST[id_rumah]','$_POST[no_rumah]','$_POST[type_rumah]','$_POST[status]')");
                  if ($query) {
                    echo "<script>location='data_rumah.php?success';</script>";
                  } else {
                    echo "<script>location='data_rumah.php?failed';</script>";
                  }
                }
                ?>
                </div>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-md">
                      ...
                      <tbody>
                        <?php
                        $no = 1;
                        $sql = mysqli_query($koneksi, "SELECT * FROM data_rumah INNER JOIN type ON data_rumah.type_rumah = type.id");
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="edit_rumah.php?id_rumah=<?= $row['id_rumah']; ?>" class="btn btn-sm btn-success"><i class="bi bi-pencil-square"></i></a>
                            <a href="hapus_rumah.php?id_rumah=<?= $row['id_rumah']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah yakin ingin menghapus data?');"><i class="bi bi-trash-fill"></i></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
