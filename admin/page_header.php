        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <div class="row mt-3 mb-5">
            <div class="col-md-12">
              ...
              <h6 class="card-header">Input Data Halaman Header</h6>
              <div class="card-body">
                <form method="post" enctype="multipart/form-data">
                  ...
                  <?php
                  $tb_header = mysqli_query($koneksi, "SELECT * FROM header");
                  $cek = mysqli_num_rows($tb_header);
                ...
                <?php
                  ...
                  if (isset($_POST['save'])) 
                  {
                      ...
                      $query = mysqli_query($koneksi,"INSERT INTO header(id,deskripsi,image_header)VALUES
                          ('$id','$deskripsi','$nama_foto')");
                      if ($query) 
                      {
                          echo "<script>location='page_header.php?success';</script>";
                      } else {
                          echo "<script>location='page_header.php?failed';</script>";
                      }
                  }
          ...
          <div class="row my-3">
            <div class="col-md-12">
              <div class="card border-left-primary shadow h-100">
                <h6 class="card-header">Data Halaman Header</h6>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-striped table-md">
                      ...
                      <tbody>
                        <?php
                        $no = 1;
                        $sql = mysqli_query($koneksi, "SELECT * FROM header");
                        ...
                        <tr>
                          ...
                          <td><?= $row['deskripsi']; ?></td>
                          <td>
                            <a href="edit_header.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-success mb-1"><i class="bi bi-pencil-square"></i></a>
