...
// query data
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * FROM brosur WHERE id='$id'");
      ...
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2"><i class="bi bi-file-image"></i> Edit Brosur</h1>
          </div>

          <div class="row mt-3 mb-5">
            <div class="col-md-12">
              <div class="card border-left-primary shadow h-100">
              <h6 class="card-header">Edit Brosur Klayan Regency</h6>
              <div class="card-body">
                ...
                if (isset($_POST['save'])) {
                  ...
                  if ($type_file == "application/pdf") {
                    ...
                    if (!empty($source)) {
                      ...
                      $query = mysqli_query($koneksi, "UPDATE brosur SET id='$id', file='$nama_file' WHERE id='$id'");
                    } else {
                      $query = mysqli_query($koneksi, "UPDATE brosur SET id='$id' WHERE id='$id'");
                    }

                      if ($query) 
                        {
                            echo "<script>location='input_brosur.php?update-success';</script>";
                        } else {
                            echo "<script>location='input_brosur.php?update-failed';</script>";
                        }
                  }
